...
const SingUpForm = () => {
    ...
    const localizationsOptions = [
        ...
        {
            id: 'kamionki',
            label: t('forms.localizationsOptions.kamionki'),
            value: 'kamionki',
        },
        {
            id: 'ligowcy',
            label: t('forms.localizationsOptions.ligowcy'),
            value: 'ligowcy',
        },
        {
        ...
        {
            id: 'treningiOnline',
            label: t('forms.localizationsOptions.treningiOnline'),
            value: 'treningiOnline',
        },
        {
            id: 'treningWStudio',
            label: t('forms.localizationsOptions.treningWStudio'),
            value: 'treningWStudio',
        },
        {
            id: 'other',
